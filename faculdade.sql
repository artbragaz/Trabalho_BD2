...
-- -----------------------------------------------------
-- Table `sakila`.`Materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Materia` (
...
-- -----------------------------------------------------
-- Table `sakila`.`Curso_has_Materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Curso_has_Materia` (
  `Curso_codigo` INT NOT NULL,
  `Materia_codMateria` INT NOT NULL,
  PRIMARY KEY (`Curso_codigo`, `Materia_codMateria`),
  INDEX `fk_Curso_has_Materia_Materia1_idx` (`Materia_codMateria` ASC),
  INDEX `fk_Curso_has_Materia_Curso1_idx` (`Curso_codigo` ASC),
  CONSTRAINT `fk_Curso_has_Materia_Curso1`
    FOREIGN KEY (`Curso_codigo`)
    REFERENCES `sakila`.`Curso` (`codCurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Curso_has_Materia_Materia1`
    FOREIGN KEY (`Materia_codMateria`)
    REFERENCES `sakila`.`Materia` (`codMateria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sakila`.`Professor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Professor` (
...
-- -----------------------------------------------------
-- Table `sakila`.`Disciplina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Disciplina` (
  `codDisciplina` INT NOT NULL,
  `Materia_codMateria` INT NOT NULL,
  `vagas` VARCHAR(45) NULL,
  `Professor_matriculaProfessor` INT NOT NULL,
  PRIMARY KEY (`codDisciplina`),
  INDEX `fk_Disciplina_Materia1_idx` (`Materia_codMateria` ASC),
  INDEX `fk_Disciplina_Professor1_idx` (`Professor_matriculaProfessor` ASC),
  ...
  CONSTRAINT `fk_Disciplina_Professor1`
    ...
    REFERENCES `sakila`.`Professor` (`matriculaProfessor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sakila`.`Aluno` (
  ...
  INDEX `fk_Aluno_Curso1_idx` (`Curso_codCurso` ASC),
...
-- Table `sakila`.`email`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`email` (
  `codEmail` INT NOT NULL,
  `email` VARCHAR(45) NULL,
  `Aluno_matricula` INT NOT NULL,
  PRIMARY KEY (`codEmail`),
  INDEX `fk_email_Aluno1_idx` (`Aluno_matricula` ASC),
  CONSTRAINT `fk_email_Aluno1`
    FOREIGN KEY (`Aluno_matricula`)
    REFERENCES `sakila`.`Aluno` (`matricula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
